...
app.listen(PORT, () => {
  ...
  // Warn if SMTP config is missing
  if (!process.env.SMTP_HOST || !process.env.SMTP_USER || !process.env.SMTP_PASSWORD) {
    console.warn('⚠️  Warning: SMTP configuration is missing. Email sending will fail.');
    console.warn('   Please set SMTP_HOST, SMTP_USER, SMTP_PASSWORD, and SENDER_EMAIL in your .env file');
  }
});
